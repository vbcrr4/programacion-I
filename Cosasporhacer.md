...
## Los ítems con asterisco son los más difíciles de arreglar
...
4- ~~Arreglar las imágenes del menú principal~~
    4.1- Agregar una pestaña en algún lugar donde se puedan cambiar la imagen de la comida? (No se que tan necesario sea)
5- Que los botones "siguiente" y "anterior" no estén fuera de la pantalla (Es decir que haya que scrollear para verlos)
...
7- En Panel de Empleado:
    7.1 En cargar nuevo pedido, que al hacer click en productos, salgan todos los productos disponibles
        ...
        7.1.3 Que no te deje agregar pedidos a usuarios que no sean cliente
        7.1.4 Agregar un mensaje de error (O de información) al agregar un pedido
...
9-En Panel Admin
    9.1- En pestaña gestión menú
        ...
        9.1.3- ~~Los productos no muestran las categorías que tienen~~
            9.1.3.1- Eliminar el pequeño espacio que sobra debajo de la categoría amarilla
        9.1.4- El buscador de categoría debería desplegar las categorías disponibles en los productos (Esto solo funcionaría si
        las categorías fueran enums)
...
10- ~~Agregar productos a la db que tengan otra categoría excepto "Food"~~ (Acá surge la pregunta, debería ser un enum la categoría?) Ahora existe el producto coca-cola, categorá "Drinks"
